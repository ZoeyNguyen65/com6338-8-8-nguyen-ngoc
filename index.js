...
form.addEventListener('submit', (event) => {
    ...
    inputField.value = ''; //To reset input field value//
    weatherSection.innerHTML = ''; //To reset weather section content//
    weatherSection.style.display = 'none'; //To reset display property//
